            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="compViewandDeleteAdmin.jsp">Missing View&Delete</a></li>
                            <li><a href="FoundcompViewandDeleteAdmin.jsp">Found View&Delete</a></li>
                        </ul>
                                 ...
                                 <table class="table">
                                        ...
                                        <tbody>
									         <%                                 
									          ...
									          PreparedStatement ps=con.prepareStatement("select * from missingperson where status=?");
